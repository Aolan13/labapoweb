...
function ch(obj)
{
	...
	switch (Math.trunc(n/12))
 	{
 		case 0: s+="green "; break;
 		case 1: s+="red "; break;
 		case 2: s+="yellow "; break;
 		case 3: s+="white "; break;
 	...
 	switch (n%12)
 	{
 		case 0: s+="rat"; break;
 		case 1: s+="cow"; break;
 		case 2: s+="tiger"; break;
 		case 3: s+="hare"; break;
 		case 4: s+="dragon"; break;
 		case 5: s+="snake"; break;
 		case 6: s+="horse"; break;
 		case 7: s+="sheep"; break;
 		case 8: s+="monkey"; break;
 		case 9: s+="chicken"; break;
 		case 10: s+="dog"; break;
 		case 11: s+="pig"; break;
		case -1: s+="cow"; break;
		case -2: s+="tiger"; break;
